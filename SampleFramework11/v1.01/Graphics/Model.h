...
struct MeshMaterial
{
    ...
    {
        SerializeItem(serializer, AmbientAlbedo);
        SerializeItem(serializer, DiffuseAlbedo);
        SerializeItem(serializer, SpecularAlbedo);
        SerializeItem(serializer, Emissive);
        SerializeItem(serializer, SpecularPower);
        SerializeItem(serializer, Alpha);
